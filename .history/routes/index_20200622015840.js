...
router.post("/uploadMeme", ((req, res, next) => {
    ...
    Jimp.read(pathToMemes + img, (err, meme) => {
        ...
        Jimp.loadFont(Jimp.FONT_SANS_32_WHITE)
            .then(font => {
                meme.print(font, w / 2 - Jimp.measureText(font, header) / 2, h / 2 - Jimp.measureTextHeight(font, header), header, Jimp.measureText(font, header), Jimp.measureTextHeight(font, header));
